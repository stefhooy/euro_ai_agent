...
def test_calculate_budget_under_budget():
    ...
    # Food cost for mid_range is €45/day. For 5 days = €225
    # Grand total = 200 + 300 + 100 + 225 = 825
    
    result = calculate_budget(trip_plan, user_budget=1000.0, travel_style="mid_range", duration=5)
...
def test_calculate_budget_over_budget():
    ...
    # Food cost for backpacker is €20/day. For 10 days = €200
    # Grand total = 500 + 600 + 200 + 200 = 1500
    
    result = calculate_budget(trip_plan, user_budget=1000.0, travel_style="backpacker", duration=10)
