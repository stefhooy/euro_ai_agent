...
def test_accommodation_returns_correct_structure():
    result = estimate_accommodation(
        ["Barcelona"], {"Barcelona": 3}, "mid_range"
    )
...
def test_accommodation_nightly_cost_backpacker_range():
    ...
    result = estimate_accommodation(
        ["Barcelona"], {"Barcelona": 1}, "backpacker"
    )
...
def test_accommodation_peak_month_more_expensive_than_offpeak():
    peak = estimate_accommodation(
        ["Barcelona"],
        {"Barcelona": 2},
        "mid_range",
        travel_month=7,
    )
    offpeak = estimate_accommodation(
        ["Barcelona"],
        {"Barcelona": 2},
        "mid_range",
        travel_month=1,
    ...
    assert (
        peak["total_accommodation_cost"]
        > offpeak["total_accommodation_cost"]
    )
